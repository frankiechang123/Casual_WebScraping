...
req_header={"Host":"movie.douban.com","User-Agent":"Mozilla/5.0 (Windows NT 10.0; Win64; x64; rv:67.0) Gecko/20100101 Firefox/67.0"}
start=0
movies=[]
while(start<=250):
    req_params={"start":start}
    r=requests.get("https://movie.douban.com/top250",headers=req_header,params=req_params)
    print(r.status_code)
    print(r.url)
    ...
    with open("movies.csv","w",newline="",encoding="utf-8") as csvfile:
        catagories=["rank","name","director","time","origin","genre","rating","num_review","url"]
